...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	void	SetCallBack(OnMessageProcFunc cbMessageProc, DWORD dwMessageUser,OnGetParamsFunc cbGetParams, DWORD dwGetParams, OnSetParamsFunc cbSetParams, DWORD dwSetParmas,OnRectEventFunc cbEventParams,DWORD	dwRectEventParams);
