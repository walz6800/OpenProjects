...
H264_PLAY_API BOOL 	CALLMETHOD 	H264_PLAY_ConvertToBmpFile(PBYTE pBuf,LONG nSize,LONG nWidth,LONG nHeight, LPCSTR sFileName);
...
H264_PLAY_API BOOL 	CALLMETHOD 	H264_PLAY_CatchPic(LONG nPort, LPCSTR sFileName) ;
